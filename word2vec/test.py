...
class word2vec:
    ...
    def initialize_weights(self):
        ...
        self.embedding_weights = np.random.uniform(-1.0, 1.0,
                                                   size=(self.dataset.vocabulary_size + 1, self.embedding_size))
        # print(self.embeddings_weights.shape)

        self.context_weights = np.random.uniform(-1.0, 1.0,
                                                 size=(self.embedding_size, self.dataset.vocabulary_size + 1))
